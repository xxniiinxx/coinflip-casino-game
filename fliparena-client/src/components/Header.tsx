...
export const Header = () => {
    ...
    const linkList = [
        ...
        { icon: <GiTwoCoins  className="group-hover:text-purple transition" />, name: 'Flip Arena', url: '/'},
        { icon: <FaCrown  className="group-hover:text-purple transition" />, name: 'Prize Pool', url: '/prize-pool-soon'},
        { icon: <FaClock  className="group-hover:text-purple transition" />, name: 'History', url: '/history-soon'},
    ...
    return <div className='px-3 md:px-4 xl:px-9 py-3 bg-bg-strong flex justify-between items-center border border-b-white/10 border-t-0 border-x-0 fixed top-0 left-0 z-30 w-full'>
        <div className='flex justify-between'>
            ...
            <p className="Geo text-white text-lg leading-10 mr-2">FlipArena</p>
